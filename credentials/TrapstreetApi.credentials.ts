...
export class TrapstreetApi implements ICredentialType {
	name = 'N8nDevTrapstreetApi';

	displayName = 'trapstreet API';

	icon: Icon = { light: 'file:../nodes/Trapstreet/trapstreet.svg', dark: 'file:../nodes/Trapstreet/trapstreet.dark.svg' };
	...
	properties: INodeProperties[] = [
		{
			...
			name: 'url',
			type: 'string',
			default: 'https://api.trapstreet.com',
			required: true,
			placeholder: 'https://api.trapstreet.com',
			description: 'The base URL of your trapstreet API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
